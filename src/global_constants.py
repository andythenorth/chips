...
graphics_temp_storage = dict(
    ...
    # unused=1,  # was fence sprite to use on the NE border
    # unused=2,  # was fence sprite to use on the NW border
    # unused=3,  # was fence sprite to use on the SE border
    # unused=4,  # was fence sprite to use on the SW border
    # unused=5,  # was y-offset for fence sprite to use on the NE border
    # unused=6,  # was y-offset for fence sprite to use on the NW border
    # unused=7,  # was y-offset for fence sprite to use on the SE border
    # unused=8,  # was y-offset for fence sprite to use on the SW border
    # unused=9,  # was draw fence in the NE
    # unused=10,  # was draw fence in the NW
    # unused=11,  # was draw fence in the SE
    # unused=12,  # was draw fence in the SW
